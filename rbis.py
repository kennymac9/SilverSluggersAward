...
allData[['AVG', 'SF', 'K%', 'SLG', 'PA', 'AB']] = preprocessing.scale(allData[['AVG', 'SF', 'K%', 'SLG', 'PA', 'AB']])

# assign X and Y sets for regression
X = allData[['AVG', 'SF', 'K%', 'SLG', 'PA', 'AB']].values
...
weightedRunStats2019 = weightedRunStats2019[['weightAVG', 'weightPA', 'weightSF', 'weightK', 'weightSLG' ,'weightAB']]
...
X_2019 = weightedRunStats2019[['weightAVG', 'weightPA', 'weightSF', 'weightK', 'weightSLG', 'weightAB']].values
...
weightedRunStats2019['RBIsPredicted'] = y_pred_list
print(weightedRunStats2019.sort_values(by=['RBIsPredicted'], ascending=False))
